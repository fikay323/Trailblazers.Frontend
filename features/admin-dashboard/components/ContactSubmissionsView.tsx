...
import { ChevronLeft, ChevronRight, MessageSquare, Mail, Clock, User, ExternalLink, Trash2, AlertTriangle } from 'lucide-react';
...
export function ContactSubmissionsView({ apiKey }: ContactSubmissionsViewProps) {
	...
	const [itemToDelete, setItemToDelete] = useState<ContactSubmissionDTO | null>(null);
	...
	return (
		<div className="space-y-6">
			...
			{error ? (
				...
				<div className="space-y-4">
					<ContactTable items={items} onSelect={setSelectedItem} onDelete={setItemToDelete} />
				...
				<DialogContent className="border-slate-800 bg-slate-950 text-slate-100 max-w-md">
					<DialogHeader className="space-y-2">
						...
						<DialogDescription className="text-slate-400 text-sm leading-relaxed">
							Are you sure you want to permanently delete the contact inquiry from{' '}
